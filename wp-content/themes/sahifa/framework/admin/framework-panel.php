...
<div class="mo-panel">
	<div class="mo-panel-tabs">
		...
		<ul>
			...
			<li class="tie-tabs tie-rate tie-not-tab"><a target="_blank" href="https://uptheme.ir/product/sahifa/"><span class="dashicons-before dashicons-star-filled tie-icon-menu"></span><?php _e( 'Rate', 'tie' ) ?> <?php echo THEME_NAME ?></a></li>
			<li class="tie-tabs tie-more tie-not-tab"><a target="_blank" href="https://uptheme.ir/product-category/wp-theme/"><span class="dashicons-before dashicons-art tie-icon-menu"></span><?php _e( 'More Themes', 'tie' ) ?></a></li>
		</ul>
		<div class="clear"></div>
	</div> <!-- .mo-panel-tabs -->
